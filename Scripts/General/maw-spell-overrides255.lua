...
modi = 1
	...
	damage = Game.CalcSpellDamage(monster.Spell, spellSkill, spellMastery, 0) * ((Mlevel/20)+0.75) * (Mlevel^1.2/1000+1) * modi
	else
	damage = Game.CalcSpellDamage(monster.Spell, spellSkill, spellMastery, 0) * ((Mlevel/20)+0.75) * modi
	end
