...
evt.map[44] = function()
	evt.ForPlayer("All")
		...
		evt.MoveToMap{X = 13836, Y = -50, Z = -2303, Direction = 1024, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "0"}
		Game.ShowStatusText("You get lost in the spacetime distorsion")
		end
end

evt.map[100] = function()
evt.MoveToMap{X = 6398, Y = 1909, Z = -1151, Direction = 1536, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "0"}
Game.ShowStatusText("Something pulled you from behind")
end


function events.DeathMap(t)
	t.Name = "zddb10.blv"
	XYZ(Party, -512, -1088, -450)
	Party.Direction = 1536
	Party.LookAngle = 0
	Sleep(1)
	Game.ShowStatusText("Death can't bring you back from this dimension")
end
